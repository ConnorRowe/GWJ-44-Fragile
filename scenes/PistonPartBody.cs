...
namespace Fragile
{
    public class PistonPartBody : Node2D
    {
        ...
        [Export]
        public Vector2 CollisionShapeOffset { get { return (collisionShape2D == null ? Vector2.Zero : collisionShape2D.Position); } set { collisionShape2D.Position = collisionStartPos + value.Rotated(Rotation); } }
